...
import { Cateegorie } from 'src/app/models/Category';
...
title: any;
c: any;
afficheDesc(id:number) {
  //2 methode de filtrage si on click sur image affiche alert description 

 /* this.categories.forEach(element =>{
    if(element.id==id) alert(element.description);
  })*/
